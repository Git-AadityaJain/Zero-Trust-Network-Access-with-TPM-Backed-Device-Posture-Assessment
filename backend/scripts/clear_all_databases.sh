...
# Script to clear all data from all databases
...
echo ""
echo "1. Clearing ZTNA Platform Database..."
docker exec -it ztna-db psql -U ztnauser -d ztna <<EOF
...
docker exec -it ztna-keycloak-db psql -U keycloak -d keycloak <<EOF
...
echo "=========================================="
echo ""
echo "Note: Keycloak will need to re-import the realm."
echo "Restart Keycloak to re-import realm-export.json:"
